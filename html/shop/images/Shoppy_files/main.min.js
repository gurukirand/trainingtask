...
$('#exchangeRefundModal').modal('show');
...
$('.shop-by-brands-slider').owlCarousel({
	loop: true,
	margin: 0,
	nav: true,
	dots: false,
...
$(".hover-dropdown a").hover(
	function () {
		...
		$(this).parent('.account-menu__list-item').siblings().removeClass('open');
	},
	function () {
...
//offer viewmore product detail & cart
$('.offer__viewmore').on('click', function () {
	$('.offer__section').addClass('offer__section--opened');
	$('body').addClass('overlay');
});
$('.offer__close').on('click', function () {
	$('.offer__section').removeClass('offer__section--opened');
	$('body').removeClass('overlay');
});

//offer viewmore product detail
$('.nav-menu__list-item')
	.on('mouseover', function () {
		$(this).siblings().children('.nav-menu__link').removeClass('active');
		$(this).children('.nav-menu__link').addClass('active');

	})
	.on('mouseleave', function () {
		$(this).children('.nav-menu__link').removeClass('active');
	});

// first and last shaded slider
var carousel = $(".new-arrivals-slider");
...
function checkClasses() {
	...
	$('.new-arrivals-slider .owl-stage .owl-item').removeClass('firstActiveItem lastActiveItem');

	$('.new-arrivals-slider .owl-stage .owl-item.active').each(function (index) {
		if (index === 0) {
...
$('.mob-dropdown-icon').on("click", function (e) {
	e.preventDefault();
	var megaMenu = $(this).parent().siblings();
	if (megaMenu.hasClass('slideDown')) {
		$(this).removeClass('arrow-reverse');
		megaMenu.removeClass('slideDown');
		megaMenu.slideUp();

	} else {
		$(this).addClass('arrow-reverse');
		megaMenu.addClass('slideDown');
		megaMenu.slideDown();
...
$('.custom-radio input[type="radio"]').change(function () {
	if ($(this).attr('id') == 'return-radio01') {

		$('.exchange-form').show();
		$('.refund-form').hide();
	} else if ($(this).attr('id') == 'return-radio02') {
		$('.exchange-form').hide();
		$('.refund-form').show();
	}
});
...
$('.category-topoffer-slider').owlCarousel({
    loop:true,
    margin:0,
    nav:true,
    dots:true,
...
$('.category-brands-slider').owlCarousel({
    loop:false,
    margin:0,
    nav:true,
    dots:false,
...
$('.category-arrival-slider').owlCarousel({
    loop:false,
    margin:0,
    nav:true,
    dots:false,
...
$("#brand").click(function(){
	...
	$("#men-brand").addClass("category-list__expanded");
});

$("#men-cloth").click(function(){
	$("#men-cloth ").addClass("category-list__expanded");
});


$(".category-list__close").click(function(){
	$(".category-list__panel").removeClass("category-list__expanded");
});


jQuery(document).ready(function($) {
$('.category-list__nstSlider').nstSlider({
			"crossable_handles": false,
			"left_grip_selector": ".category-list__leftGrip",
			"right_grip_selector": ".category-list__rightGrip",
			"value_bar_selector": ".category-list__bar",
			"value_changed_callback": function (cause, leftValue, rightValue) {
				$(this).parent().find('.category-list__leftLabel').text(leftValue);
				$(this).parent().find('.category-list__rightLabel').text(rightValue);
			}
		});
});

var qaMainHead = $('.category-list__filter-bx h5');
 qaMainHead.click(function () {
        if ($(this).hasClass('active')) {
            $(this).removeClass('active');
            $(this).siblings('.category-list__filter-inr').stop(true, true).slideDown();
        }
        else {
            $(this).addClass('active');
            $(this).siblings('.category-list__filter-inr').stop(true, true).slideUp(); 
        }
    });